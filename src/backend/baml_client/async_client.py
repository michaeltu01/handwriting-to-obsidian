...
class BamlAsyncClient:
    ...
    async def ExtractNoteContent(self, img: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> str:
        # Check if on_tick is provided
        if 'on_tick' in baml_options:
            # Use streaming internally when on_tick is provided
            __stream__ = self.stream.ExtractNoteContent(img=img,
                baml_options=baml_options)
            return await __stream__.get_final_response()
        else:
            # Original non-streaming code
            __result__ = await self.__options.merge_options(baml_options).call_function_async(function_name="ExtractNoteContent", args={
                "img": img,
            })
...
class BamlStreamClient:
    ...
    def ExtractNoteContent(self, img: baml_py.Image,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[str, str]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_async_stream(function_name="ExtractNoteContent", args={
            "img": img,
        })
...
class BamlHttpRequestClient:
    ...
    async def ExtractNoteContent(self, img: baml_py.Image,
        ...
        __result__ = await self.__options.merge_options(baml_options).create_http_request_async(function_name="ExtractNoteContent", args={
            "img": img,
        }, mode="request")
        return __result__
