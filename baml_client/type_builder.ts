...
export default class TypeBuilder {
    ...
    HandwrittenNote: ClassViewer<'HandwrittenNote', "title" | "summary" | "content" | "original_note">;
    ...
    constructor() {
        ...
        this.HandwrittenNote = this.tb.classViewer("HandwrittenNote", [
          "title","summary","content","original_note",
        ]);
